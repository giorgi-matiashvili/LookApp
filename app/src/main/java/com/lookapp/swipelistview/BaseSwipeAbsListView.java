 ...
 */
public abstract class BaseSwipeAbsListView extends FrameLayout implements AbsListView.OnScrollListener {
    ...
    public BaseSwipeAbsListView(Context context) {
        super(context);
        initView();
    }

    public BaseSwipeAbsListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
        initView();
    }

    public BaseSwipeAbsListView(Context context, AttributeSet attrs, int defStyle) {
